...
public class Register extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(hoTen.isEmpty() || hoTen.isBlank()){
            JOptionPane.showMessageDialog(null, "Họ Tên ko dc để trống");
            return;
        }
        if(gioiTinh.isEmpty() || gioiTinh.isBlank()){
            JOptionPane.showMessageDialog(null, "Giới Tính ko dc để trống");
            return;
        }
        if(queQuan.isEmpty() || queQuan.isBlank()){
            JOptionPane.showMessageDialog(null, "Quê Quán ko dc để trống");
            return;
        }
        
        NguoiDungDTO nguoiDungDTO = new NguoiDungDTO();
        nguoiDungDTO.setTaiKhoan(username);
        nguoiDungDTO.setMatKhau(password);
         nguoiDungDTO.setHoTen(hoTen);
          nguoiDungDTO.setNamSinh(namSinh);
           nguoiDungDTO.setQueQuan(queQuan);
            nguoiDungDTO.setGioiTinh(gioiTinh);
            
        try{
            int success = NguoiDungDAO.register(nguoiDungDTO);
            if(success > 0){
                JOptionPane.showMessageDialog(null, "Đăng ký Thành công");
            }
            else{
                JOptionPane.showMessageDialog(null, "Đăng ký Ko Thành công");
            }
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, "Đăng ký Ko Thành công");
